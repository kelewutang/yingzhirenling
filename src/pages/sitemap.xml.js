...
export async function GET() {
  ...
  const entries = [...legacyPages, ...getPublishedWeapons(knowledge).map((weapon) => [`/weapons/${weapon.slug}`, weapon.updatedAt])];
